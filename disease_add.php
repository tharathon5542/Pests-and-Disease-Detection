            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">เพิ่มข้อมูลโรคพืชผัก</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">หน้าแรก</a></li>
                            <li class="breadcrumb-item"><a href="disease.php">ข้อมูลโรคพืชผัก</a></li>
                            <li class="breadcrumb-item active">เพิ่มข้อมูลโรคพืชผัก</li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <form method="post" action="src/disease_add_db.php" enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputDiseasecode">รหัสโรคพืชผัก</label>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputDiseaseward">การกักกันโรค</label>
                                ...
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="small mb-1" for="selectDiseaselinkvetgetable">ชนิดพืชที่เกิดโรคนี้</label>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-success btn-block" name="add_disease_link_vetgetable" id="add_disease_link_vetgetable" style="margin-top: 27px;">เพิ่มรายการ</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    <div class="col-md-2">
                                        <button class="btn btn-success btn-block" name="add_disease" id="add_disease">เพิ่มข้อมูล</button>
                                    </div>
                                </div>
                            </form>                
                            </div>
