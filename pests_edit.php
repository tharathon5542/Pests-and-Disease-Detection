            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">ข้อมูลแมลงศัตรูพืช</h1>
                            ...
                            <form method="post" action="src/pests_edit_db.php" enctype="multipart/form-data">
                                <div class="form-row">
                                    <?php 
                                        if($_SESSION['userRole'] == "admin"){
                                            ...
                                            echo        '<label class="small mb-1" for="inputPestscode">รหัสแมลงศัตรูพืช</label>';
                                ...
                                <?php 
                                    ...
                                    if($_SESSION['userRole'] == "admin"){
                                        ...
                                        echo        '<div class="form-group">';
                                        echo            '<label class="small mb-1" for="selectPestslinkvetgetable">ชนิดพืชที่มีแมลงศัตรูพืชชนิดนี้</label>';
                                        ...
                                        echo    '<div class="col-md-2">';
                                        echo        '<div class="form-group">';
                                        echo            '<button type="button" class="btn btn-success btn-block" name="add_pests_link_vetgetable" id="add_pests_link_vetgetable" style="margin-top: 27px;">เพิ่มรายการ</button>';
                                        echo        '</div>';
                                        echo    '</div>';
                                        echo    '<div class="col-md-2">';
                                        echo        '<div class="form-group">';
                                        // echo            '<button type="button" class="btn btn-danger btn-block" name="del_pests_link_vetgetable" id="del_pests_link_vetgetable" style="margin-top: 27px;">ลบรายการ</button>';
                                        echo        '</div>';
                                        echo    '</div>';
                                        echo '</div>';
                                    }  
                                                        ...
                                                        <tbody id="add_pests_link_vetgetable_table">
                                                            <?php 
                                                                ...
                                                                while($rows = mysqli_fetch_array($query_tmp_pests_link_vetgetable)){
                                                                    ...
                                                                    if($_SESSION['userRole'] == "admin"){
                                                                        echo '<td><button type="button" class="btn btn-danger btn-block" name="del_pests_link_vetgetable" id="del_pests_link_vetgetable" onClick="testDelLink('. $rows['TMP_PLV_CODE'] .')" >ลบรายการ</button></td>';
                                                                    }
                                                                    echo '</tr>';
                                                                }
                                                            ?>
                                ...
                                <?php 
                                    ...
                                    if($_SESSION['userRole'] == "admin"){
                                        echo '<div class="form-row">
                                                <div class="col-md-2">
                                                    <button class="btn btn-primary btn-block" name="edit_pests" id="edit_pests">แก้ไขข้อมูล</button>
                                                </div>
                                            </div>';
                                    }
                                ?>            
