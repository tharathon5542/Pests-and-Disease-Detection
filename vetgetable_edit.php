            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">ข้อมูลพืชผักสวนครัว</h1>
                            ...
                            <form method="post" action="src/vetgetable_edit_db.php" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                ...
                                                ตารางแสดงรายการโรคที่เกิดกับผักชนิดนี้
                                            </div>
                                            <div class="card-body">
                                                        ...
                                                        <tbody >
                                                                ...
                                                                <?php 
                                                                    while($rows = mysqli_fetch_array($query_disease_link_vetgetable)){
                                                                        ...
                                                                        echo '</td>';
                                                                        echo '<td><a href="disease_edit.php?dcode='. $result_disease_data['D_CODE'] . '&link='. $result_vetgetable_data['V_CODE'] .'"><button type="button" class="btn btn-primary btn-block" name="vetgetable_detail" id="vetgetable_detail">รายละเอียด</button></a></td>';
                                                                        echo '</tr>';
                                                                    }
                                                                ?>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                <i class="fas fa-table mr-1"></i>
                                                ตารางแสดงรายการแมลงศัตรูที่เกิดกับผักชนิดนี้
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered"  width="100%" cellspacing="0">
                                                        <thead>
                                                            <tr>
                                                                <th style="width: 10%;">ชื่อแมลงศัตรูพืช</th>
                                                                <th>ภาพแมลงศัตรูพืช</th>
                                                                <th style="width: 20%;">รายละเอียด</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody >
                                                                ...
                                                                <?php 
                                                                    while($rows = mysqli_fetch_array($query_pests_link_vetgetable)){
                                                                        ...
                                                                        echo '</td>';
                                                                        echo '<td><a href="pests_edit.php?pcode='. $result_pests_data['P_CODE'] . '&link='. $result_vetgetable_data['V_CODE'] .'"><button type="button" class="btn btn-primary btn-block" name="vetgetable_detail" id="vetgetable_detail">รายละเอียด</button></a></td>';
                                                                        echo '</tr>';
                                                                    }
                                                                ?>
                                ...
                                <?php 
                                    ...
                                    if($_SESSION['userRole'] == "admin"){
                                        echo '<div class="form-row">
                                                <div class="col-md-2">
                                                    <button class="btn btn-primary btn-block" name="edit_vetgetable" id="edit_vetgetable">แก้ไขข้อมูล</button>
                                                </div>
                                            </div>';
                                    }
                                ?>    
